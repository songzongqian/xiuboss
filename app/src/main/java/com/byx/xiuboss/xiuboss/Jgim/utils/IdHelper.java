...
public class IdHelper { public static int getLayout(Context context, String layoutName) {
    ...
    public static int[] getResourceDeclareStyleableIntArray(Context context, String name) {
        try {
            ...
            Field[] fields2 = Class.forName("com.byx.xiuboss.xiuboss" + ".R$styleable").getFields();
